                          ...
                          <div v-for="characterService in character.services" :key="characterService">
                            ...
                            <transition>
                              <div v-if="isOpenCharacterInsideServicesId.indexOf(characterService.id) != -1" class="flex flex-col gap-[23px] mt-[23px]">
                                ...
                                <template v-if="characterService.specialBlocksText" >
                                  <div v-for="blockText in characterService.specialBlocksText" :key="blockText" class="backdrop-blur-xs leading-6 border-dapink border rounded-[30px] py-[5%] px-[7%]">
                                      <div v-if="blockText.beforeHeadText">{{ blockText.beforeHeadText }}</div>
                                      <div class="bg-dablue text-white font-['Soroka'] ">{{ blockText.head }}</div>
                                      <div v-for="li in blockText.list" :key="li">
                                        <div>
...

  {
    ...
    services: {
      ...
      childs: {
        ...
        specialBlocksText: {
          block1: {
            beforeHeadText: 'Идеальное развлечение для детей от 2 до 14 лет!',
            head: 'МЫ ПРЕДЛАГАЕМ:',
            list: {
              li1: {
                head: '',
                text: 'Активные игры и захватывающие квесты'
              },
              li2: {
                head: '',
                text: 'Умные задания для развития креативности'
              },
              li3: {
                head: '',
                text: 'Отличное музыкальное сопровождение'
              },
              li4: {
                head: '',
                text: 'Проведение в помещении или на свежем воздухе'
              }
            }
          }
        },
    ...
    characters: {
        trolli: {
          ...
          imgs: {
            img1: '/src/assets/img/animators/trolli/sm/trolli1_sm.jpg',
            img2: '/src/assets/img/animators/trolli/sm/trolli2_sm.jpg',
          },
          title: 'РОЗОЧКА ИЗ М/Ф «ТРОЛЛИ»',
          services: {
            postcard: {
              id: 'animators_trolli_service_1',
              titleService: 'ЖИВАЯ ОТКРЫТКА ИГРОВОГО ПЕРСОНАЖА',
              timeService: '(15 минут)',
              priceService: '2000 РУБ + ТАКСИ',
              texts: {
        ...
        unicorn: {
          id: 'animators_character_2',
          gen_img: '/src/assets/img/animators/unicorn/sm/unicorn_sm.jpg',
          imgs: {
            img1: '/src/assets/img/animators/unicorn/sm/unicorn1_sm.jpg',
            img2: '/src/assets/img/animators/unicorn/sm/unicorn2_sm.jpg',
          },
          title: 'ЕДИНОРОЖКА ИСКОРКА ИЗ «МАЙ ЛИТТЛ ПОНИ»',
          services: {
            postcard: {
              id: 'animators_unicorn_service_1',
              titleService: 'ЖИВАЯ ОТКРЫТКА ИГРОВОГО ПЕРСОНАЖА',
              timeService: '(15 минут)',
              priceService: '2000 РУБ + ТАКСИ',
              texts: {
            ...
            childs: {
              id: 'animators_unicorn_service_2',
              titleService: 'ДЕТСКАЯ ИГРОВАЯ ПРОГРАММА',
              timeService: '(30 минут)',
              priceService: 'ОТ 2600 РУБ + ТАКСИ',
              texts: {
        ...
        sky: {
          id: 'animators_character_3',
          gen_img: '/src/assets/img/animators/sky/sm/sky_sm.jpg',
          imgs: {
            img1: '/src/assets/img/animators/sky/sm/sky1_sm.jpg',
            img2: '/src/assets/img/animators/sky/sm/sky2_sm.jpg',
            img3: '/src/assets/img/animators/sky/sm/sky3_sm.jpg'
          },
          title: 'СКАЙ ИЗ ЩЕНЯЧЬЕГО ПАТРУЛЯ',
          services: {
            postcard: {
              id: 'animators_sky_service_1',
              titleService: 'ЖИВАЯ ОТКРЫТКА ИГРОВОГО ПЕРСОНАЖА',
              timeService: '(15 минут)',
              priceService: '2000 РУБ + ТАКСИ',
              texts: {
        ...
        marshal: {
          id: 'animators_character_4',
          gen_img: '/src/assets/img/animators/marshal/sm/marshal_sm.jpg',
          imgs: {
            img1: '/src/assets/img/animators/marshal/sm/marshal1_sm.jpg',
            img2: '/src/assets/img/animators/marshal/sm/marshal2_sm.jpg',
            img3: '/src/assets/img/animators/marshal/sm/marshal3_sm.jpg'
          },
          title: 'МАРШАЛ ИЗ ЩЕНЯЧЬЕГО ПАТРУЛЯ',
          services: {
            postcard: {
              id: 'animators_marshal_service_1',
              titleService: 'ЖИВАЯ ОТКРЫТКА ИГРОВОГО ПЕРСОНАЖА',
              timeService: '(15 минут)',
              priceService: '2000 РУБ + ТАКСИ',
              texts: {
            ...
            childs: {
              id: 'animators_marshal_service_2',
              titleService: 'ДЕТСКАЯ ИГРОВАЯ ПРОГРАММА',
              timeService: '(30 минут)',
              priceService: 'ОТ 2600 РУБ + ТАКСИ',
              texts: {
        ...
        ice_cream: {
          id: 'animators_character_5',
          gen_img: '/src/assets/img/animators/ice_cream/sm/ice_cream_sm.jpg',
          imgs: {
            img1: '/src/assets/img/animators/ice_cream/sm/ice_cream1_sm.jpg',
            img2: '/src/assets/img/animators/ice_cream/sm/ice_cream2_sm.jpg',
          },
          title: 'МАРШАЛ ИЗ ЩЕНЯЧЬЕГО ПАТРУЛЯ',
          services: {
            postcard: {
              id: 'animators_ice_cream_service_1',
              titleService: 'ЖИВАЯ ОТКРЫТКА ИГРОВОГО ПЕРСОНАЖА',
              timeService: '(15 минут)',
              priceService: '2000 РУБ + ТАКСИ',
              texts: {
            ...
            childs: {
              id: 'animators_ice_cream_service_2',
              titleService: 'ДЕТСКАЯ ИГРОВАЯ ПРОГРАММА',
              timeService: '(30 минут)',
              priceService: 'ОТ 2600 РУБ + ТАКСИ',
              texts: {
        ...
        spider: {
          id: 'animators_character_6',
          gen_img: '/src/assets/img/animators/spider/sm/spider_sm.jpg',
          imgs: {
            img1: '/src/assets/img/animators/spider/sm/spider1_sm.jpg',
            img2: '/src/assets/img/animators/spider/sm/spider2_sm.jpg',
          },
          title: 'МАРШАЛ ИЗ ЩЕНЯЧЬЕГО ПАТРУЛЯ',
          services: {
            postcard: {
              id: 'animators_spider_service_1',
              titleService: 'ЖИВАЯ ОТКРЫТКА ИГРОВОГО ПЕРСОНАЖА',
              timeService: '(15 минут)',
              priceService: '2000 РУБ + ТАКСИ',
              texts: {
        ...
        cold_heart: {
          id: 'animators_character_7',
          gen_img: '/src/assets/img/animators/cold_heart/sm/cold_heart_sm.jpg',
          imgs: {
            img1: '/src/assets/img/animators/cold_heart/sm/cold_heart1_sm.jpg',
            img2: '/src/assets/img/animators/cold_heart/sm/cold_heart2_sm.jpg',
          },
          title: 'АННА ИЗ ХОЛОДНОГО СЕРДЦА',
          services: {
            postcard: {
              id: 'animators_cold_heart_service_1',
              titleService: 'ЖИВАЯ ОТКРЫТКА ИГРОВОГО ПЕРСОНАЖА',
              timeService: '(15 минут)',
              priceService: '2000 РУБ + ТАКСИ',
              texts: {
            ...
            childs: {
              id: 'animators_cold_heart_service_2',
              titleService: 'ДЕТСКАЯ ИГРОВАЯ ПРОГРАММА',
              timeService: '(30 минут)',
              priceService: 'ОТ 2600 РУБ + ТАКСИ',
              texts: {
        ...
        snow_white: {
          id: 'animators_character_8',
          gen_img: '/src/assets/img/animators/snow_white/sm/snow_white_sm.jpg',
          imgs: {
            img1: '/src/assets/img/animators/snow_white/sm/snow_white1_sm.jpg',
            img2: '/src/assets/img/animators/snow_white/sm/snow_white2_sm.jpg',
          },
          title: 'БЕЛОСНЕЖКА',
          services: {
            postcard: {
              id: 'animators_snow_white_service_1',
              titleService: 'ЖИВАЯ ОТКРЫТКА ИГРОВОГО ПЕРСОНАЖА',
              timeService: '(15 минут)',
              priceService: '2000 РУБ + ТАКСИ',
              texts: {
            ...
            childs: {
              id: 'animators_snow_white_service_2',
              titleService: 'ДЕТСКАЯ ИГРОВАЯ ПРОГРАММА',
              timeService: '(30 минут)',
              priceService: 'ОТ 2600 РУБ + ТАКСИ',
              texts: {
        ...
        pirate: {
          id: 'animators_character_9',
          gen_img: '/src/assets/img/animators/pirate/sm/pirate_sm.jpg',
          imgs: {
            img1: '/src/assets/img/animators/pirate/sm/pirate1_sm.jpg',
            img2: '/src/assets/img/animators/pirate/sm/pirate2_sm.jpg',
            img3: '/src/assets/img/animators/pirate/sm/pirate3_sm.jpg',
          },
          title: 'ПИРАТКА',
          services: {
            postcard: {
              id: 'animators_pirate_service_1',
              titleService: 'ЖИВАЯ ОТКРЫТКА ИГРОВОГО ПЕРСОНАЖА',
              timeService: '(15 минут)',
              priceService: '2000 РУБ + ТАКСИ',
              texts: {
        ...
        batman: {
          id: 'animators_character_10',
          gen_img: '/src/assets/img/animators/batman/sm/batman_sm.jpg',
          imgs: {
            img1: '/src/assets/img/animators/batman/sm/batman1_sm.jpg',
            img2: '/src/assets/img/animators/batman/sm/batman2_sm.jpg',
          },
          title: 'БЭТМЕН',
          services: {
            postcard: {
              id: 'animators_batman_service_1',
              titleService: 'ЖИВАЯ ОТКРЫТКА ИГРОВОГО ПЕРСОНАЖА',
              timeService: '(15 минут)',
              priceService: '2000 РУБ + ТАКСИ',
              texts: {
        ...
        astronaut: {
          id: 'animators_character_11',
          gen_img: '/src/assets/img/animators/astronaut/sm/astronaut_sm.jpg',
          imgs: {},
          title: 'КОСОМНАВТ',
          services: {
            postcard: {
              id: 'animators_astronaut_service_1',
              titleService: 'ЖИВАЯ ОТКРЫТКА ИГРОВОГО ПЕРСОНАЖА',
              timeService: '(15 минут)',
              priceService: '2000 РУБ + ТАКСИ',
              texts: {
            ...
            childs: {
              id: 'animators_astronaut_service_2',
              titleService: 'ДЕТСКАЯ ИГРОВАЯ ПРОГРАММА',
              timeService: '(30 минут)',
              priceService: 'ОТ 2600 РУБ + ТАКСИ',
              texts: {
        ...
        tiktok: {
          id: 'animators_character_12',
          gen_img: '/src/assets/img/animators/tiktok/sm/tiktok_sm.jpg',
          imgs: {
            img1: '/src/assets/img/animators/tiktok/sm/tiktok1_sm.jpg',
            img2: '/src/assets/img/animators/tiktok/sm/tiktok2_sm.jpg',
            img3: '/src/assets/img/animators/tiktok/sm/tiktok3_sm.jpg',
          },
          title: 'БЛОГЕР В СОЦСЕТИ',
          services: {
            postcard: {
              id: 'animators_tiktok_service_1',
              titleService: 'ЖИВАЯ ОТКРЫТКА ИГРОВОГО ПЕРСОНАЖА',
              timeService: '(15 минут)',
              priceService: '2000 РУБ + ТАКСИ',
              texts: {
        ...
        gramm: {
          id: 'animators_character_13',
          gen_img: '/src/assets/img/animators/gramm/sm/gramm_sm.jpg',
          imgs: {
            img1: '/src/assets/img/animators/gramm/sm/gramm1_sm.jpg',
            img2: '/src/assets/img/animators/gramm/sm/gramm2_sm.jpg',
            img3: '/src/assets/img/animators/gramm/sm/gramm3_sm.jpg',
          },
          title: 'БЛОГЕР В СОЦСЕТИ',
          services: {
            postcard: {
              id: 'animators_gramm_service_1',
              titleService: 'ЖИВАЯ ОТКРЫТКА ИГРОВОГО ПЕРСОНАЖА',
              timeService: '(15 минут)',
              priceService: '2000 РУБ + ТАКСИ',
              texts: {
